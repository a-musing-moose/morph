 ...
 * @subpackage Query
 */
class Property implements \morph\IQuery
{
     ...
     * @return Morph_Query_Property
     */
    public function sort($direction = \morph\Enum::DIRECTION_ASC)
    {
        switch ($direction) {
            case \morph\Enum::DIRECTION_ASC:
                $this->sortDirection = \morph\Enum::DIRECTION_ASC;
                break;
            case \morph\Enum::DIRECTION_DESC:
                $this->sortDirection = \morph\Enum::DIRECTION_DESC;
                break;
            default:
