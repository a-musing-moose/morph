...
require_once 'MongoConstraint/CollectionExists.php';
require_once 'MongoConstraint/CollectionDoesNotExist.php';
require_once 'MongoConstraint/DocumentExists.php';
require_once 'MongoConstraint/DocumentPropertyEquals.php';
